...
with colname:
    playerinput = st.text_input("What is your name", value="", max_chars=30, key="playername",help=None, autocomplete=None, on_change=None, args=None, kwargs=None, placeholder="your name here", disabled=False, label_visibility="visible")
...
if st.session_state['human_player'] == "":
    ...
    with st.form('form_ttt'):
        ...
        with colx:
            ...
            cplay = st.number_input(label="row number", min_value=0, max_value=2, value=0, step=None,
            ...
            rplay = st.number_input(label="col number", min_value=0, max_value=2, value=0, step=None,
        ...
        if submit_input:
            ...
            if pruefe_gewonnen(brett, test):
                ...
                with cole:
                    st.write("Go on!")
            with cole:
                st.write(f"{st.session_state['game_over']}")
