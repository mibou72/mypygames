...
def initialize_session_state():
    ...
    if 'cplay' not in st.session_state or st.session_state['cplay'] != 0:
        st.session_state['cplay'] = 0
    if 'rplay' not in st.session_state or st.session_state['rplay'] != 0:
        st.session_state['rplay'] = 0
